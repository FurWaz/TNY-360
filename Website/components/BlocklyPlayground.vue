...
(window as any).onBlockStart = onBlockStart; // doing this to avoid function removal by minifier
...
(window as any).onBlockEnd = onBlockEnd; // doing this to avoid function removal by minifier
